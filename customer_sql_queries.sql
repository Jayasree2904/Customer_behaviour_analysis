...
-- 3. What are the top 5 products with the highest average rating review
select item_purchased,ROUND(AVG(CAST(review_rating AS DECIMAL(10,2))), 2) AS avg_review
from customer
...
select count(customer_id) as repeat_customers,subscription_status
from customer
